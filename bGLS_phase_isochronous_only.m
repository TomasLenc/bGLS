%%%%%%%%%%%%%%%%%%%
% This method computes the bGLS for the case of isochronous
% For most practical uses bGLS_phase_model_single_and_multiperson
% this version is used when there are multiple rendition of isochronous
% data, and was wrote to compare eassily with the bounded Vorberg and
% Schulze method.
%
...
function [alpha,st,sm]=bGLS_phase_isochronous_only(As,MEAN_A)
ITER=20;
TRESH=1e-3;
